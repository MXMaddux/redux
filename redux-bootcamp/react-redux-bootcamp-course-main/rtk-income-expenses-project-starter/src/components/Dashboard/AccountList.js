    ...
    <>
      {accounts?.length <= 0 ? (
        <div className="flex justify-center align-middle">
          <Link
            to={"/add-account"}
            className="inline-flex text-center mt-5 mb-8 items-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            Add New Account
          </Link>
        </div>
